...
fetch(`${window.location.hostname == "themonstrousdev.github.io" || window.location.hostname == "themonstrousdev.github.io" || window.location.hostname == "localhost" ? "." : "https://themonster.github.io/" }/docs/profiles.json`)
  .then(res => {
    return res.json();
  })
  .then(data => {
